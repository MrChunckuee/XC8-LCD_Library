...
void main(void) {
    ...
    do { if ( 2 == 0 ) { LCD_Command(0x80 + 1); } else if ( 2 == 1 ) { LCD_Command(0xC0 + 1); } else if ( 2 == 2 ) { LCD_Command(0x94 + 1); } else if ( 2 == 3 ) { LCD_Command(0xD4 + 1); } } while(0);
    LCD_puts("mrchunckuee.blog-");
    do { if ( 3 == 0 ) { LCD_Command(0x80 + 11); } else if ( 3 == 1 ) { LCD_Command(0xC0 + 11); } else if ( 3 == 2 ) { LCD_Command(0x94 + 11); } else if ( 3 == 3 ) { LCD_Command(0xD4 + 11); } } while(0);
    LCD_puts("spot.com");
    ...
    while (1) {
        if(LCDUpdate){
            ...
            LCD_DrawBigDigit(0, 0, 1);
            LCD_DrawBigDigit(1, 0, 4);
            LCD_DrawBigDigit(2, 0, 7);
            LCD_DrawBigDigit(3, 0, 10);
            LCD_DrawBigDigit(4, 0, 13);
            LCD_DrawBigDigit(5, 2, 5);
            LCD_DrawBigDigit(6, 2, 8);
            LCD_DrawBigDigit(7, 2, 11);
            LCD_DrawBigDigit(8, 2, 14);
            LCD_DrawBigDigit(9, 2, 17);
            LCDUpdate = 0;
        }
    }
